...
def build_unet(IMG_WIDTH=256, IMG_HEIGHT=256, IMG_CHANNELS=3):
    ...
    u11 = concatenate([u11, c1], axis=3)						# switch order
    ...
    outputs = Conv2D(1, (1, 1), activation='sigmoid') (c11)			# relu, sigmoid
